...
def filter_countries(**kwargs: str) -> List["CountryInfo"]:
    ...
    # Normalise keys to lowercase for case-insensitive comparison where appropriate
    normalised = {k: v for k, v in kwargs.items()}
...
def _matches(data: dict, criteria: dict) -> bool:
